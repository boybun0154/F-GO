...
public class CustomerDAO {
    ...
    public List<Customer> getBlacklist() {
        List<Customer> list = new ArrayList<>();
        String query = "select account.accountID, account,customerID,customerName,phone,email,nationalID,drivingLicense,faceImg from account  join customer \n"
        ...
        try {
            ...
            while (rs.next()) {
                list.add(new Customer(rs.getInt(1),
                        rs.getString(2), rs.getInt(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9)));
            }
        } catch (Exception e) {
        }
        return list;
    ...
    public void deleteBlacklist(String cid) {
