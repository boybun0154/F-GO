        ...
        <div id="wrapper" class="clearfix">
            ...
            <jsp:include page="header.jsp"></jsp:include>
                ...
                <section id="content">
                    ...
                    <div style="animation: scroll 30s linear infinite;" id="related-portfolio" class="owl-carousel owl-carousel-full portfolio-carousel carousel-widget" data-margin="0" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4">
